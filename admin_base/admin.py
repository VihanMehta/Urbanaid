...
class ProfesionalAdmin(admin.ModelAdmin):
    list_display= ['order_id','ServiceName','slot','date','user','professional','razorpay_orderId','razorpay_payment_id','address','pincode','amount','booked']
    list_editable=['slot','date','booked']
